...
public static class ServiceExtensions
{
    public static void AddCustomServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IGroupRolePermissionRepository, GroupRolePermissionRepository>();
        services.AddScoped<IChannelRolePermissionRepository, ChannelRolePermissionRepository>();
        services.AddScoped<IChannelRolePermissionService, ChannelRolePermissionService>();
        services.AddScoped<IGroupRolePermissionService, GroupRolePermissionService>();
    }
}
